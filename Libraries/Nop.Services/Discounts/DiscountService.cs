...
namespace Nop.Services.Discounts
{
    ...
    public partial class DiscountService : IDiscountService
    {
        ...
        /// 
        /// RGT 05.23.2018-Simplifying; only need one function call to IsDiscountCValid.
        /*public virtual bool IsDiscountValid(Discount discount, Customer customer, Product product)
        {
            if (discount == null)
                throw new ArgumentNullException("discount");
            ...
            return IsDiscountValid(discount, customer, product, couponCodeToValidate);
        }
        */
        #endregion
        ...
        public virtual bool IsDiscountValid(Discount discount, Customer customer, Product product)
        {
            ...
            //check coupon code
            //RGT 05.23.2018 Context has changed...
            //Dealer (customer) won't enter the Coupon Code as NOP designed.
            //Discount Coupon Code will be compared to Product Tag...
            //If Equal... Discount will get applied.
            #region "RGT-NOT NEEDED"

            /*if (discount.RequiresCouponCode)
            {
              //throw new ArgumentNullException("In Required...,", "SOOO DONE, YEAH!!!");
            ...
            */
            ...
            if (discount.DiscountType == DiscountType.AssignedToParts &&
                partTag != discount.CouponCode)
                return false;
            ...
            {
                //*throw new ArgumentNullException("Hast Start Date", "SOOO DONE, YEAH!!!");
            ...
            #region "RGT-NOT NEEDED"
            /* RGT 05.22.2018 - Plugin requirments not working... make custom for Min Qty.
            if (!CheckDiscountLimitations(discount, customer))
                return false;

            //discount requirements

            //throw new ArgumentNullException("Before Requirements", "SOOO DONE, YEAH!!!");
            ...
            */
            ...
            //Check Minium Qty ordered requirment...
            var parmProductID = new SqlParameter("@ProductID", product.Id);

            int quantityOrdered = _dbContext.SqlQuery<int>("SPROC_PO_Discounts_MinQty_Check @ProductID", parmProductID).FirstOrDefault();
            
            if (quantityOrdered < discount.MinQty)
                return false;
            return true;
        }
