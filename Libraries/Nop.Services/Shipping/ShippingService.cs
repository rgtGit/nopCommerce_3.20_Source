...
namespace Nop.Services.Shipping
{
    ...
    public partial class ShippingService : IShippingService
    {
        ...
        private readonly IRepository<ShippingDrop> _shippingDropRepository;
        ...
        public ShippingService(
            ...
            IRepository<ShippingDrop> shippingDropRepository,
            ...
            IDbContext dbContext)
        {
            ...
            this._shippingDropRepository = shippingDropRepository;
        ...
        private class SPROC_ShippingRageByType  // RGT
        {
        ...
        /// <summary>
        /// Looks up the shipping by Zone (State) --- RGT
        /// </summary>
        /// <param name="state">The State selected in Shipping Address
        /// <returns>Shipping rate</returns>
        public virtual decimal ShippingRateByZone(string ShippingType, string State)
        {
           decimal temp;
            switch (ShippingType)
            {
                case "Truck":
                    ...
                    break;
                case "FedEx Freight":
                    return  _dbContext.SqlQuery<decimal>("ShippingRateByZone @ShippingType", new SqlParameter("@ShippingType", State)).First();
                    break;
                case "Container":
                    return 0;
                    break;
        ...
        /// <summary>
        /// Gets all Drop Ship Settings
        /// </summary>
        /// <returns>Shipping Drop collection</returns>
        public virtual IList<ShippingDrop> GetAllDropShipSettings()
        {
            
            
                var query = from sm in _shippingDropRepository.Table
                            select sm;
                var shippingMethods = query.ToList();
                return shippingMethods;
        ...
        public virtual ShippingDrop GetShippingDropById(int shippingDropId)
        {
            if (shippingDropId == 0)
                return null;

            return _shippingDropRepository.GetById(shippingDropId);
        }



        /// <summary>
        /// Updates the Drop Ship Setting
        /// </summary>
        /// <param name="shippingDropSetting">Shipping method</param>
        public virtual void UpdateShippingDrop(ShippingDrop shippingDropSetting)
        {
            if (shippingDropSetting == null)
                throw new ArgumentNullException("shippingDrop");

            _shippingDropRepository.Update(shippingDropSetting);

            //event notification
            _eventPublisher.EntityUpdated(shippingDropSetting);
        }
