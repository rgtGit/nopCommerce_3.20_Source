...
namespace Nop.Services.Shipping
{
    ...
    public partial interface IShippingService
    {
        ...
        /// <summary>
        /// Looks up Shipping Rate by Zone (State)...
        /// </summary>
        /// <param name="shippingMethod">State</param>
        decimal ShippingRateByZone(string ShippingType, string State);
        ...
        /// <param name="filterByCountryId">The country indentifier to filter by</param>
        /// <returns>Shipping method collection</returns>
        IList<ShippingDrop> GetAllDropShipSettings();

        
        /// <summary>
        /// Gets the Drop Ship seettings
        /// </summary>
        /// <param name="shippingDroprId">Drop Ship Setting iD</param>
        /// <returns>Drop Ship Setting</returns>
        ShippingDrop GetShippingDropById(int shippingDropId);

        
        /// <summary>
        /// Updates the Drop Ship Settings
        /// </summary>
        /// <param name="shippingDropSetting">Shipping method</param>
        void UpdateShippingDrop(ShippingDrop  shippingDropSetting);
