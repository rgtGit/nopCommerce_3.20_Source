...
namespace Nop.Services.Customers
{
    ...
    public partial interface ICustomerService
    {
        ...
        /// <summary>
        /// Returns status of CreditHold for any given customer...
        /// </summary>
        /// <param name="Division"></param>
        /// <param name="AccountNo"></param>
        /// 
        bool CustomerCheckCreditHold(string DivisionNo, string AccountNo);


        /// <summary>
        /// Returns a row from the DB if TermsCode="01" (PrePay)
        /// </summary>
        /// <param name="Division"></param>
        /// <param name="AccountNo"></param>
        /// 
        bool CustomerCheckPrePay(string DivisionNo, string AccountNo);


        /// <summary>
        /// Returns a row from the DB if Dealer Exempt from PrePay
        /// </summary>
        /// <param name="Division"></param>
        /// <param name="AccountNo"></param>
        /// 
        Boolean CustomerCheckExemptPrePay(string DivisionNo, string AccountNo);
