...
namespace Nop.Services.Customers
{
    ...
    public partial class CustomerService : ICustomerService
    {
        ...
        /// <summary>
        /// Retrieves the Credit Status
        /// DB-MSPAACCTSVR4\SAGE100.PartsSage100PassThru
        /// </summary>
        /// <param name="DivisionNo">ARDivsionNo.</param>
        /// <param name="AccountNo">Customer Account.</param>
        /// <returns>Credit Hold Status</returns>
        public virtual bool CustomerCheckCreditHold(string DivisionNo, string AccountNo)
        {
            string creditHold;

            creditHold = _dbContext.SqlQuery<string>("SPROC_PO_MAS200DW_CreditHoldCheck @DivisionNo, @AccountNo",
                new SqlParameter("@DivisionNo", DivisionNo), new SqlParameter("@AccountNo", AccountNo)).FirstOrDefault();
            if (creditHold == "Y") {
                return true;
            }
        ...
        /// <summary>
        /// Retrieves a row from the DB if TermsCode = "01" PrePay
        /// DB-MSPAACCTSVR4\SAGE100.PartsSage100PassThru
        /// </summary>
        /// <param name="DivisionNo">ARDivsionNo.</param>
        /// <param name="AccountNo">Customer Account.</param>
        /// <returns>Credit Hold Status</returns>
        public virtual bool CustomerCheckPrePay(string DivisionNo, string AccountNo)
        {
            string PrePay;

             PrePay = _dbContext.SqlQuery<string>("SPROC_PO_SAGEDW_PrePayCheck @DivisionNo, @AccountNo",
                new SqlParameter("@DivisionNo", DivisionNo), new SqlParameter("@AccountNo", AccountNo)).FirstOrDefault();
        ...
        /// <summary>
        /// Retrieves a row from the DB if Dealer is Exempt to PrePay...
        /// </summary>
        /// <param name="DivisionNo">ARDivsionNo.</param>
        /// <param name="AccountNo">Customer Account.</param>
        /// <returns>Credit Hold Status</returns>
        public virtual Boolean CustomerCheckExemptPrePay(string DivisionNo, string AccountNo)
        {

            string DealerExempt;

            DealerExempt = _dbContext.SqlQuery<string>("SPROC_PO_RoleCheck_ExemptPrepay @DivisionNo, @AccountNo",
                new SqlParameter("@DivisionNo", DivisionNo), new SqlParameter("@AccountNo", AccountNo)).FirstOrDefault();

            if (DealerExempt == null)
            {
                return false;
            }
