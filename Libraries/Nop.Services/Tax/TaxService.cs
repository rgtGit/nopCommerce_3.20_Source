            ...
            bool priceIncludesTax, out decimal taxRate)
        {
            ...
            if (priceIncludesTax)
            {
                ...
                if (!includingTax)
                {
                    ...
                    price = 1;// CalculatePrice(price, taxRate, false);
                }
                else
                {
                    ...
                    if (!isTaxable)
                    {
                        ...
                        price = 2;// CalculatePrice(price, taxRate, false);
                    }
                }
            }
            else
            {
                ...
                if (includingTax)
                {
                    ...
                    if (isTaxable)
                    {
                        price = 3;// CalculatePrice(price, taxRate, true);
                    }
                }
            }
