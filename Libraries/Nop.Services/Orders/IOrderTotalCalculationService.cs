...
namespace Nop.Services.Orders
{
    ...
    public partial interface IOrderTotalCalculationService
    {
        ...
        /// </summary>
        /// <param name="cart">Cart</param>
        /// <param name="dropShip">Cart</param>
        /// <param name="checkout">If this is true, we will add the freight cost</param>
        /// <returns>Shipping total</returns>
        decimal? GetShoppingCartShippingTotal(IList<ShoppingCartItem> cart, decimal dropShipCharge, bool checkout);
        ...
        */
        ...
        /// <param name="checkout">If this is true, we will add the freight cost</param>
        decimal? GetShoppingCartTotal(IList<ShoppingCartItem> cart, decimal dropShipCharge, bool checkout, bool ignoreRewardPonts = false, 
            bool usePaymentMethodAdditionalFee = true);
        ...
        decimal? GetShoppingCartTotal(IList<ShoppingCartItem> cart, decimal dropShipCharge, bool checkout,
            out decimal discountAmount, out Discount appliedDiscount,
