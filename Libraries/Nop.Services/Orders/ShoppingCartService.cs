...
{      
    ...
    public partial class ShoppingCartService : IShoppingCartService
    {
        ...
        private class ProductCustomCoverPrice  // RGT
        {
        ...
        private class DealerDiscount
        {
            public decimal Discount { get; set; }  // RGT
        }
        ...
        public virtual decimal CheckStockAvailability(string ItemCode)
        {

            return _dbContext.SqlQuery<decimal>("SPROC_PO_SAGEDW_LiveStockCheck @ItemCode", new SqlParameter("@ItemCode", ItemCode)).First();
        ...
        /// DB-MSPAACCTSVR4\SAGE100.PartsSage100PassThru
        /// </summary>
        /// <param name="PartID">Unique Part ID</param>
        /// <returns>Shipping rate</returns>
        public virtual Boolean CheckPartTag_IsAccessory(Int32 partID)
        {
            string tagACC;

            tagACC = _dbContext.SqlQuery<string>("SPROC_PO_PartTag_ACC_Select @PartID", new SqlParameter("@PartID", partID)).FirstOrDefault();
        ...
        /// </summary>
        public virtual void EmptyShoppingCart(Customer customer)
        {
                    ...
                    decimal customerEnteredPrice, int quantity, bool automaticallyAddRequiredProductsIfEnabled)
       {
            ...
            // Determine if Part is an Accessory (this flag the order for Prepay, unless exceptions are met...
            Boolean tagACC;

                        
            tagACC = CheckPartTag_IsAccessory(product.Id);
