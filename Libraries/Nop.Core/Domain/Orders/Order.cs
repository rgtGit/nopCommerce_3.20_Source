...
namespace Nop.Core.Domain.Orders
{
    ...
    public partial class Order : BaseEntity
    {
        ...
        /// <summary>
        /// Gets or sets the Drop Ship Charge
        /// </summary>
        public decimal? DropShipCharge { get; set; }
        ...
        /// <summary>
        /// Gets or sets the desired ship date
        /// </summary>
        ...
        /// <summary>
        /// Will display all orders based on Order Filter
        /// </summary>
        //public List<OrderDetails> FilteredOrders { get; set; }

        public class OrderFilterDetails
        {
