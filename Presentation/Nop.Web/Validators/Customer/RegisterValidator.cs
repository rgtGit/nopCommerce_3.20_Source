...
namespace Nop.Web.Validators.Customer
{
    public class RegisterValidator : AbstractValidator<RegisterModel>
    {
        ...
        {
            RuleFor(x => x.Account).NotEmpty().WithMessage(localizationService.GetResource("Account.Fields.Account.Required"));
            RuleFor(x => x.ZipCode).NotEmpty().WithMessage(localizationService.GetResource("Account.Fields.ZipCode.Required"));
