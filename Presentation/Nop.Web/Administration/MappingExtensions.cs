...
namespace Nop.Admin
{
    public static class MappingExtensions
    {
        ...
        public static ShippingDropModel ToModel(this ShippingDrop entity)
        {
            return Mapper.Map<ShippingDrop, ShippingDropModel>(entity);
        }

        public static ShippingDrop ToEntity(this ShippingDropModel model, ShippingDrop destination)
        {
            return Mapper.Map(model, destination);
        }
