...
namespace Nop.Web.Controllers
{
    public partial class CustomerController : BaseNopController
    {
        ...
        protected CustomerNavigationModel GetCustomerNavigationModel(Customer customer)
        {
            ...
            model.HideRewardPoints = true;              //!_rewardPointsSettings.Enabled;
        ...
        protected void PrepareCustomerInfoModel(CustomerInfoModel model, Customer customer, bool excludeProperties)
        {
            ...
            if (!excludeProperties)
            {
                ...
                model.DealerName = customer.DealerName;
            }
            else
            {
            ...
            //model.CreditHold = Call stored procedure to see if customer is Credit Hold...
            //model.CreditHold = _customerService.CustomerCheckCreditHold(_workContext.CurrentCustomer.AccountNo);
        ...
        public ActionResult Register(RegisterModel model, string returnUrl, bool captchaValid)
        {
            ...
            /* RGT - 09.04.2014  validate CAPTCHA
            ...
            if (ModelState.IsValid)
            {
                ...
                customer.AccountNo = model.Account;
                customer.AdminComment = model.ZipCode;    
