...
namespace Nop.Web.Controllers
{
    public partial class CatalogController : BaseNopController
    {
        ...
        protected IEnumerable<ProductOverviewModel> PrepareProductOverviewModels(IEnumerable<Product> products, 
            ...
            bool forceRedirectionAfterAddingToCart = true)
        {
            if (products == null)
            ...
            foreach (var product in products)
            {
                                            ...
                                            if (_permissionService.Authorize(StandardPermissionProvider.DisplayPrices))
                                            {
                                                ...
                                                foreach (var associatedProduct in associatedProducts)
                                                {
                                                    ...
                                                    var tmpPrice = _priceCalculationService.GetFinalPrice(associatedProduct,
                                                        _workContext.CurrentCustomer, decimal.Zero, true, out decimal itemDiscount, int.MaxValue);
                        ...
                        default:
                            {
                                ...
                                {   //calculate for the maximum quantity (in case if we have tier prices)
                                    ...
                                    //RGT-05.16.2018:  GetFinalPrice (Set 4 parm-includeDiscount to false;
                                    //we don't want discount applied until the cart page.)
                                    decimal minPossiblePrice = _priceCalculationService.GetFinalPrice(product,
                                        _workContext.CurrentCustomer, decimal.Zero, false, out decimal itemDiscount, int.MaxValue);
                                    if (!product.CustomerEntersPrice)
                                    {
                                        ...
                                        else
                                        {
                                            ...
                                            //oldPriceBase = _taxService.GetProductPrice(product, product.OldPrice, out taxRate);
                                            //throw new Exception(minPossiblePrice.ToString());
                                            ...
                                            finalPrice =  _currencyService.ConvertFromPrimaryStoreCurrency(minPossiblePrice, _workContext.WorkingCurrency);
                                            ...
                                            {
                                                priceModel.OldPrice = null;
                                                priceModel.Price = "1";//String.Format(_localizationService.GetResource("Products.PriceRangeFrom"), _priceFormatter.FormatPrice(finalPrice));
                                            }
                                            else
                                            {
                                                if (finalPriceBase != oldPriceBase && oldPriceBase != decimal.Zero)
                                                {
                                                    ...
                                                    priceModel.Price = "2";//_priceFormatter.FormatPrice(finalPrice);
                                                }
                                                else
                                                {
                                                    priceModel.OldPrice = null;
                ...
                if (preparePictureModel)
                {
                    ...
                    {
                        string imgPath = Properties.Settings.Default["Parts_ImagePath"].ToString();
                        var picture = _pictureService.GetPicturesByProductId(product.Id, 1).FirstOrDefault();
                        var pictureModel = new PictureModel()
                        {
                            //ImageUrl = _pictureService.GetPictureUrl(picture, pictureSize),
                            ImageUrl = imgPath + product.Sku + "_125.jpg",
            ...
            ShoppingCartItem updatecartitem = null, bool isAssociatedProduct = false)
        {
            ...
            var cachedPictures = _cacheManager.Get(productPicturesCacheKey, () =>
            {
                ...
                var defaultPictureModel = new PictureModel()
                {
                    ...
                    ImageUrl = imgPath + product.Sku + "_300.jpg",
                ...
                .Select(tierPrice =>
                            {
                                ...
                                decimal taxRate = decimal.Zero;
                                decimal priceBase = 0.00M; //_taxService.GetProductPrice(product, _priceCalculationService.GetFinalPrice(product, _workContext.CurrentCustomer, decimal.Zero, _catalogSettings.DisplayTierPricesWithDiscounts, tierPrice.Quantity), out taxRate);
